...
function createData(id, accountId, receivingAccountId, date, amount,comment) {
    return { id, accountId, receivingAccountId, date, amount,comment};
  }
  ...
  const rows = [
    ...
    createData(1, 15975858, 6859694, "2022-11-08" ,501.00, 'Monthly Pocket Money'),
